...
| `sample_outputs.md` | Generated text samples, filled in after running |
...
3. Copy generated samples into `sample_outputs.md`.
...
- [Predictive Text and Text Generation — Allison Parrish](https://github.com/aparrish/predictive-text-and-text-generation/blob/master/predictive-text-and-text-generation.ipynb) —
  this notebook's structure (manual n-gram table construction, then `markovify` for sentence-level
  generation, then comparing chain order) follows the approach demonstrated here.
...
- [markovify](https://github.com/jsvine/markovify) — jsvine
- [Project Gutenberg](https://www.gutenberg.org/) — public-domain text corpus
- Allison Parrish's "Predictive Text and Text Generation" notebook (see Reference above)
